<div class="flex mb-4 items-center justify-center">
    <div class="w-1/3">
        ...
        <div class="bg-slate-50 text-slate-500 dark:bg-slate-600 dark:text-slate-200 rounded-b-xl flex items-center">
            ...
            <button type="button" class="bg-white text-slate-900 dark:bg-slate-600 dark:text-slate-700 flex-none -my-2 mx-auto w-20 h-20 rounded-full ring-1 ring-slate-900/5 shadow-md flex items-center justify-center" aria-label="Pause">
